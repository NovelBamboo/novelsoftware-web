...
The three-page site uses HTML, Tailwind CSS via CDN, a shared CSS layer, and light vanilla JavaScript. Netlify Functions and PostgreSQL support remain available for future bounded workflows.
